...
+(AlmondStatus *)getMasterAlmondStatus:(SFIRouterSummary*)routerSummary{
    ...
    [self getStatus:almondStat name:name location:location connetedVia:@"Directly" interface:@"Wired" signalStrength:@"" ssid1:ssid[@"2G"] ssid2:ssid[@"5G"] internetStat:YES isMaster:YES active:YES hop:0];
    return almondStat;
}
