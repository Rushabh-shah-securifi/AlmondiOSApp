...
//                buttonHue.valueType = deviceIndex.valueType;
                ...
                [hueColorPickupLabelView setUpValues:NSLocalizedString(@"rule_hue", @"  Hue") withSelectButtonTitle:NSLocalizedString(@"select", @"Select")];
                ...
                [saturationSliderLabelView setUpValues:NSLocalizedString(@"rule_saturation", @"  Saturation") withSelectButtonTitle:NSLocalizedString(@"select", @"Select")];
...
//                    preValue = [saturationSlider convertToSensorValue];
                ...
                [brightnessSliderLabelView setUpValues:NSLocalizedString(@"rule_brightness", @"  Brightness") withSelectButtonTitle:NSLocalizedString(@"select", @"Select")];
