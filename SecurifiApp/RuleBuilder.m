...
//
//
//@interface RuleBuilder()<UIPickerViewDelegate,UIPickerViewDataSource>
...
//@property(nonatomic) RulesTableViewController *ruleTable;
//@end
//
//
//@implementation RuleBuilder
//PreDelayRuleButton *rulesButtonViewClick;
//bool isTrigger;
//
...
//}
//
//-(RulesIndexValueSupport*)createRulesActionIndexValueSupport:(NSString*)iconName text:(NSString*)displayText title:(NSString*)title layoutType:(NSString*)layoutType suffix:(NSString*)suffix withDeviceID:(sfi_id)deviceID delay:(NSString*)delay positionId:(int)positionId withMatchData:(NSString*)matchData{
...
//    
//    if(isTrigger)
//        [self.rulesTriggersIndexValSupport addObject:rulesValSupport];
//    else
//        [self.rulesActionsIndexValSupport addObject:rulesValSupport];
//    return rulesValSupport;
//}
//
//-(RulesIndexValueSupport*)createRulesIndexValueSupport:(NSString*)iconName text:(NSString*)displayText title:(NSString*)title layoutType:(NSString*)layoutType suffix:(NSString*)suffix withDeviceID:(sfi_id)deviceID positionId:(int)positionId withMatchData:(NSString*)matchData{
//    RulesIndexValueSupport *rulesValSupport = [RulesIndexValueSupport new];
//    rulesValSupport.iconName = iconName;
//    rulesValSupport.displayText = displayText;
//    rulesValSupport.title = title;
...
//            [self.rulesTriggersIndexValSupport addObject:[self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:@"Mode" layoutType:@"" suffix:@"" withDeviceID:buttonProperties.deviceId delay:0 positionId:positionId withMatchData:buttonProperties.matchData]];
//        }
//    }
//}
//-(void)addModeIndexValuesForPropertiesAction:(SFIButtonSubProperties *)buttonProperties positionId:(int)positionId{
//    NSArray *deviceIndexes=[self getDeviceIndexes:buttonProperties.deviceType];
//    SFIDeviceIndex *deviceIndex = deviceIndexes[0];
//    NSArray *indexValues = deviceIndex.indexValues;
//    for(IndexValueSupport *iVal in indexValues){
//        if([buttonProperties.matchData isEqualToString:iVal.matchData]){
//            [self.rulesActionsIndexValSupport addObject:[self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:@"Mode" layoutType:@"" suffix:@"" withDeviceID:buttonProperties.deviceId delay:buttonProperties.delay positionId:positionId withMatchData:buttonProperties.matchData]];
//           
//        }
//    }
//}
...
//                    [self.rulesTriggersIndexValSupport addObject:[self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:myDevice.name layoutType:@"" suffix:@"" withDeviceID:(myDevice.deviceID).intValue delay:0 positionId:positionId withMatchData:buttonProperties.matchData]];
//                }
//            }
//        }
//    }
...
//        NSLog(@" button subproperty index %d,matchdata %@,device name %@,devicce id %d",buttonProperties.index,buttonProperties.matchData,buttonProperties.deviceName,buttonProperties.deviceId);
...
//                 NSLog(@" button propety %@ %d %d",buttonProperties.matchData,buttonProperties.deviceId,buttonProperties.index);
...
//                                    [self.rulesTriggersIndexValSupport addObject:[self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:myDevice.deviceName layoutType:iVal.layoutType suffix:iVal.valueFormatter.suffix withDeviceID:myDevice.deviceID delay:0 positionId:positionId withMatchData:buttonProperties.matchData]];
//                                    break;
//                                }
//                                else if([iVal.layoutType isEqualToString:@"dimButton"] ){ //to do handle device 2
//                                    //buttonProperties.matchData has current data
//                                    NSLog(@" button property match data %@",buttonProperties.matchData);
//                                    [self.rulesTriggersIndexValSupport addObject:[self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:myDevice.deviceName layoutType:iVal.layoutType suffix:iVal.valueFormatter.suffix withDeviceID:myDevice.deviceID delay:0 positionId:positionId withMatchData:buttonProperties.matchData]];
//                                    break;
//                                }
...
//        positionId++;
//    }
//    NSLog(@"rulesTriggersIndexValSupport count %ld and %@",(unsigned long)self.rulesTriggersIndexValSupport.count,self.rulesTriggersIndexValSupport);
//}
//
//
////-(void) createTriggersRulesIndexValArray{
...
//    int positionId = 0;
//    
//    NSMutableArray *subPropertyList = isTrigger?self.rule.triggers:self.rule.actions;//2
//    
//    for (SFIButtonSubProperties *buttonProperties in subPropertyList) {
//        NSString *delay = isTrigger?NULL:buttonProperties.delay;//1
//        
//        NSLog(@" button sub property %@ %d",buttonProperties.matchData ,buttonProperties.index);
//        if(buttonProperties.deviceType == SFIDeviceType_BinarySwitch_0){
//            [self addModeIndexValuesForPropertiesAction:buttonProperties positionId:positionId];
//        }
//        else if(buttonProperties.deviceType == SFIDeviceType_WIFIClient){
//            [self addWifiClientsIndexValuesForProperties:buttonProperties positionId:positionId];
//            
...
//                
////                if ([self.actionsView istoggle:myDevice.deviceType] && !isTrigger) {
...
//                        NSArray *indexValues = deviceIndex.indexValues;
//                        for(IndexValueSupport *iVal in indexValues){
//                            NSLog(@"device id: %d, index: %d match data: %@", myDevice.deviceID, deviceIndex.indexID,buttonProperties.matchData);
//                            if([iVal.matchData isEqualToString:buttonProperties.matchData]){
//                                NSLog(@"button properties. delay: %@", buttonProperties.delay);
//                                
//                                [self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:myDevice.deviceName layoutType:iVal.layoutType suffix:iVal.valueFormatter.suffix withDeviceID:myDevice.deviceID delay:delay positionId:positionId withMatchData:buttonProperties.matchData];
//                                break;
//                            }
//                            else if([iVal.layoutType isEqualToString:@"dimButton"] ){ //to do - handle device 2
//                                [self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:myDevice.deviceName layoutType:iVal.layoutType suffix:iVal.valueFormatter.suffix withDeviceID:myDevice.deviceID delay:buttonProperties.delay positionId:positionId withMatchData:buttonProperties.matchData];
//                                break;
//                            }
//                            else if([iVal.layoutType isEqualToString:@"hue"]){
//                                [self createRulesActionIndexValueSupport:iVal.iconName text:iVal.displayText title:myDevice.deviceName layoutType:iVal.layoutType suffix:iVal.valueFormatter.suffix withDeviceID:myDevice.deviceID delay:buttonProperties.delay positionId:positionId withMatchData:buttonProperties.matchData];
...
//    PreDelayRuleButton *hueButton = [[PreDelayRuleButton alloc] initWithFrame:CGRectMake(xVal, 5, rulesButtonsViewWidth, rulesButtonsViewHeight)];
...
//    NSLog(@"action-delay: %@ match data %@", rVal.delay,rVal.matchData);
...
//    rulesButtonViewClick = (PreDelayRuleButton*)[sender superview];
