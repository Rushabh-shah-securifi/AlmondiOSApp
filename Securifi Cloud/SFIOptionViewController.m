...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    lblOption.text = [optionList objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"Row Clicked %d - Option %@", indexPath.row, [optionList objectAtIndex:indexPath.row]);
    [[self  selectedOptionDelegate]optionSelected:[optionList objectAtIndex:indexPath.row] forOptionType:self.optionType] ;
